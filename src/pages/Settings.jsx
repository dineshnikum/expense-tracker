                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-slate-500 dark:text-slate-400">
                                Load or remove sample transactions to test the
                                app.
                            </p>
                        </div>
                        {useStore((state) => state.hasDemoData()) ? (
                            <button
                                onClick={() => {
                                    useStore.getState().removeDemoData();
                                    // Force re-render if needed, though zustand should handle it
                                }}
                                className="px-4 py-2 rounded-xl bg-red-100 text-red-600 hover:bg-red-200 dark:bg-red-900/30 dark:text-red-400 dark:hover:bg-red-900/50 transition-colors font-medium text-sm"
                            >
                                Remove Demo Data
                            </button>
                        ) : (
                            <button
                                ...
                                className="px-4 py-2 rounded-xl bg-blue-100 text-blue-600 hover:bg-blue-200 dark:bg-blue-900/30 dark:text-blue-400 dark:hover:bg-blue-900/50 transition-colors font-medium text-sm"
                            >
                                Load Demo Data
                            </button>
                        )}
